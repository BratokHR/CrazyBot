...
extern userCmd_t *			oldcmd;

extern DWORD		MenuOpen;
extern DWORD		WritePacket;
extern DWORD		Attack;
extern DWORD		Wallhack;
extern DWORD		NoRecoil;
extern POINT		Cursor;
...
extern const xcommand_t OpenConsole;

typedef void (*g_WriteConsole)(const char *fmt); 
extern g_WriteConsole trap_WriteConsole;